...
def data_processing(nums_forgery,nums_compression,hash_len,high_threshold,hash_name):
    ...
    print("frame level")
    img_path="../data/dataset2_result/framelevel_"+hash_name+".pdf"
    ...
    print("video level")
    img_path = "../data/dataset2_result/videolevel_" + hash_name + ".pdf"
...
for i in range(len(sample_nums)):
    ...
    if sample_nums[i]<10:
        np.save('../data/dataset2/roc_videolevel_00' + str(sample_nums[i]) + '.npy', np.array(
        ...
        np.save('../data/dataset2/roc_framelevel_00' + str(sample_nums[i]) + '.npy', np.array(
        ...
        np.save('../data/dataset2/roc_videolevel_0' + str(sample_nums[i]) + '.npy', np.array(
            [fpr_videolevel_temp, tpr_videolevel_temp, precision_videolevel_temp, recall_videolevel_temp,
             F1_videolevel_temp, iou_videolevel_temp], dtype=object))
        np.save('../data/dataset2/roc_framelevel_0' + str(sample_nums[i]) + '.npy', np.array(
            [fpr_framelevel_temp, tpr_framelevel_temp, precision_framelevel_temp, recall_framelevel_temp,
             F1_framelevel_temp, iou_framelevel_temp], dtype=object))
    else:
        np.save('../data/dataset2/roc_videolevel_' + str(sample_nums[i]) + '.npy', np.array(
            [fpr_videolevel_temp, tpr_videolevel_temp, precision_videolevel_temp, recall_videolevel_temp,
             F1_videolevel_temp, iou_videolevel_temp], dtype=object))
        np.save('../data/dataset2/roc_framelevel_' + str(sample_nums[i]) + '.npy', np.array(
            [fpr_framelevel_temp, tpr_framelevel_temp, precision_framelevel_temp, recall_framelevel_temp,
             F1_framelevel_temp, iou_framelevel_temp], dtype=object))
...
plt.legend()
pl.savefig("../data/dataset2_result/framelevel_mean_benchmarks.pdf")
np.save('../data/dataset2/benchmarks_videolevel.npy',
...
plt.legend()
pl.savefig("../data/dataset2_result/framelevel_benchmarks.pdf")
...
plt.legend()
pl.savefig("../data/dataset2_result/videolevel_mean_benchmarks.pdf")
np.save('../data/dataset2/benchmarks_videolevel.npy',
...
plt.legend()
pl.savefig("../data/dataset2_result/videolevel_benchmarks.pdf")