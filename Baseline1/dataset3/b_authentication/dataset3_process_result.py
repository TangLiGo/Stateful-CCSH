...
plt.xlabel('rN')
plt.ylabel('F1')
pl.savefig("../data/dataset3_result/baseline1_d3_fl.pdf")
...
plt.xlabel('rN')
plt.ylabel('F1')
pl.savefig("../data/dataset3_result/baseline1_d3_vl.pdf")
...
plt.xlabel('rN')
plt.ylabel('F1')
pl.savefig("../data/dataset3_result/baseline1_d3_fl2.pdf")
...
plt.xlabel('rN')
plt.ylabel('F1')
pl.savefig("../data/dataset3_result/baseline1_d3_vl2.pdf")