...
sample_nums=[20,35]# time:[3126.046875] #[120,130,170,190,200] #time [2613.640625, 2834.34375, 3660.453125, 4109.71875, 4359.25]
...
for sample_num in sample_nums:
    ...
    for i in range(repeatTime):
        ...
        if sample_num<10:
            np.save('../data/hds_ahash_sample_num_00' + str(sample_num) + '.npy', hds_forgery_arr)
            np.save('../data/hds_ahash_sample_num_00' + str(sample_num) + '_compression.npy', hds_compression_arr)
        elif sample_num<100:
            np.save('../data/hds_ahash_sample_num_0' + str(sample_num) + '.npy', hds_forgery_arr)
            np.save('../data/hds_ahash_sample_num_0' + str(sample_num) + '_compression.npy', hds_compression_arr)
        else:
            np.save('../data/hds_ahash_sample_num_' + str(sample_num) + '.npy', hds_forgery_arr)
            np.save('../data/hds_ahash_sample_num_' + str(sample_num) + '_compression.npy', hds_compression_arr)
