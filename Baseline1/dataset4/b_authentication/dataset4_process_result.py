...
for file in os.listdir(data_path):
    ...
    if 'roc_' in file and 'ahash' not in file and 'deletion' not in file:
...
pl.savefig("../result/baseline1_d4_fl_marker.pdf")
...
plt.xticks(fontsize=12)
plt.yticks(fontsize=12)
pl.savefig("../result/baseline1_d4_vl_marker.pdf")
...
plt.xticks(fontsize=12)
plt.yticks(fontsize=12)
pl.savefig("../result/baseline1_d4_fl_bar.pdf")
...
plt.xticks(fontsize=12)
plt.yticks(fontsize=12)
pl.savefig("../result/baseline1_d4_vl_bar.pdf")
...
plt.xticks(fontsize=12)
plt.yticks(fontsize=12)
pl.savefig("../result/baseline1_d4_fl_ahash.pdf")
...
plt.xticks(fontsize=12)
plt.yticks(fontsize=12)
pl.savefig("../result/baseline1_d4_vl_ahash.pdf")