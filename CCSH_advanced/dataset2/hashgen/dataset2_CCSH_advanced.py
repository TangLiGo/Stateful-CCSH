...
def hash_compare(insertion_num,video_path1,video_path2,seq):

    clip = cv2.VideoCapture(video_path2)
    clip_forged = cv2.VideoCapture(video_path1)
    imgs = []
    imgs_forged = []
    while True:
    ...
    print(len(imgs),len(imgs_forged),video_path2,video_path1)
...
def compare_hd(insert_num,seq):
    data_path_original='D:/TangLi/dataset2/Original'

    data_path1 = 'D:/TangLi/dataset2/video_pro1/'
    data_path2 = 'D:/TangLi/dataset2/video_pro2/'
    data_path3 = 'D:/TangLi/dataset2/video_pro3/'
    data_path4 = 'D:/TangLi/dataset2/video_pro4/'
    data_path5 = 'D:/TangLi/dataset2/video_pro5/'
    data_path6 = 'D:/TangLi/dataset2/video_pro6/'
