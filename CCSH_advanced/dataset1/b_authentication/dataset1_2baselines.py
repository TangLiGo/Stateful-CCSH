...
for file in os.listdir(data_path_b2):
    ...
    video_path = video_path.replace('\\', '/')
    if 'roc_' in file and 'insertion' in file and 'ahash' not in file :
            if 'framelevel' in file:
...
for i in range(len_quota):
    ...
    ax.plot(fpr_ahash_framelevel,tpr_ahash_framelevel,label='ahash',color='indigo')
    ax.plot(fpr_framelevel[0],  tpr_framelevel[0],  label='RSH',color='steelblue')
    ax.plot(fpr_framelevel_b2_temp, tpr_framelevel_b2_temp, label='Global-CCSH', color='seagreen')
    ax.plot(fpr_framelevel_temp, tpr_framelevel_temp, label='Local-CCSH',color='red')
    ...
    axins.plot(fpr_ahash_framelevel, tpr_ahash_framelevel, label='ahash', color='indigo')
    axins.plot(fpr_framelevel[0],  tpr_framelevel[0],  label='RSH',color='steelblue')
    axins.plot(fpr_framelevel_b2_temp, tpr_framelevel_b2_temp, label='Global-CCSH', color='seagreen')
    axins.plot(fpr_framelevel_temp,
               tpr_framelevel_temp,color='red')
    ...
    pl.savefig("../result/d1_roc_fl_"+str(i)+"_b2_focus.pdf")
    ...
    axins.set_xlim(0.01,0.09)
    axins.set_ylim(0.9, 0.98)
