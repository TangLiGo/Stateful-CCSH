...
def drawBenchmarks(len_quota,benchmark_framelevel,benchmark_videolevel,ben_name):
    ...
    pl.savefig("../result/d1_fl_"+ben_name+"_single.pdf")
   ...
   # pl.vlines(5, 0.85, 1, color='indigo', linestyles='dashed')
    ...
    plt.xlabel('cN')
    plt.ylabel('Detection Performance')
    pl.savefig("../result/d1_vl_"+ben_name+"_single.pdf")
advanced_framelevel_path=[]
advanced_videolevel_path=[]
data_path="../../../CCSH/dataset3/data_movingobjects/"
...
b2_framelevel_path=[]
b2_videolevel_path=[]
data_path_b2="../../../Baseline2/dataset3/data_movingobjects/"
for file in os.listdir(data_path_b2):
    video_path = os.path.join(data_path_b2, file)
    video_path = video_path.replace('\\', '/')
    if 'roc_' in file and 'ahash' not in file and 'insertion' not in file:
            if 'framelevel' in file:
                b2_framelevel_path.append(video_path)
            elif 'videolevel' in file:
                b2_videolevel_path.append(video_path)
CCSH_advanced_framelevel_path=[]
CCSH_advanced_videolevel_path=[]
data_path_CCSH_advanced="../data/"
for file in os.listdir(data_path_CCSH_advanced):
    video_path = os.path.join(data_path_CCSH_advanced, file)
    video_path = video_path.replace('\\', '/')
    if 'roc_' in file and 'ahash' not in file and 'deletion' in file:
            if 'framelevel' in file:
                CCSH_advanced_framelevel_path.append(video_path)
            elif 'videolevel' in file:
                CCSH_advanced_videolevel_path.append(video_path)
...
framelevel_CCSH_advanced=[]
videolevel_CCSH_advanced=[]
for path in CCSH_advanced_framelevel_path:
    framelevel_CCSH_advanced.append(np.load(path, allow_pickle=True))
for path in CCSH_advanced_videolevel_path:
    videolevel_CCSH_advanced.append(np.load(path, allow_pickle=True))
len_quota=6
...
fpr_framelevel_CCSH_advanced = []
tpr_framelevel_CCSH_advanced = []
precision_framelevel_CCSH_advanced=[]
recall_framelevel_CCSH_advanced=[]
F1_framelevel_CCSH_advanced=[]
iou_framelevel_CCSH_advanced=[]
...
fpr_videolevel_CCSH_advanced = []
tpr_videolevel_CCSH_advanced = []
precision_videolevel_CCSH_advanced=[]
recall_videolevel_CCSH_advanced=[]
F1_videolevel_CCSH_advanced=[]
iou_videolevel_CCSH_advanced=[]
...
for i in range(len_quota):
    ...
    fpr_framelevel_CCSH_advanced_temp, tpr_framelevel_CCSH_advanced_temp, precision_framelevel_CCSH_advanced_temp, recall_framelevel_CCSH_advanced_temp, F1_framelevel_CCSH_advanced_temp, iou_framelevel_CCSH_advanced_temp =framelevel_CCSH_advanced[i]
    fpr_videolevel_CCSH_advanced_temp, tpr_videolevel_CCSH_advanced_temp, precision_videolevel_CCSH_advanced_temp, recall_videolevel_CCSH_advanced_temp, F1_videolevel_CCSH_advanced_temp, iou_videolevel_CCSH_advanced_temp =videolevel_CCSH_advanced[i]

    fpr_framelevel_CCSH_advanced.append(fpr_framelevel_CCSH_advanced_temp)
    tpr_framelevel_CCSH_advanced.append(tpr_framelevel_CCSH_advanced_temp)
    fpr_videolevel_CCSH_advanced.append(fpr_videolevel_CCSH_advanced_temp)
    tpr_videolevel_CCSH_advanced.append(tpr_videolevel_CCSH_advanced_temp)

    precision_framelevel_CCSH_advanced.append(precision_framelevel_CCSH_advanced_temp)
    recall_framelevel_CCSH_advanced.append(recall_framelevel_CCSH_advanced_temp)
    F1_framelevel_CCSH_advanced.append(F1_framelevel_CCSH_advanced_temp)
    iou_framelevel_CCSH_advanced.append(iou_framelevel_CCSH_advanced_temp)


    precision_videolevel_CCSH_advanced.append(precision_videolevel_CCSH_advanced_temp)
    recall_videolevel_CCSH_advanced.append(recall_videolevel_CCSH_advanced_temp)
    F1_videolevel_CCSH_advanced.append(F1_videolevel_CCSH_advanced_temp)
    iou_videolevel_CCSH_advanced.append(iou_videolevel_CCSH_advanced_temp)
    ...
    pl.plot(fpr_framelevel_CCSH_advanced_temp, tpr_framelevel_CCSH_advanced_temp, label='Local-CCSH_advanced', color='darkorange')
    ...
    pl.savefig("../result/d1_roc_fl_"+str(i)+"_b2.pdf")
    ...
    pl.plot(fpr_videolevel_CCSH_advanced_temp, tpr_videolevel_CCSH_advanced_temp, label='Local-CCSH_advanced', color='darkorange')
    plt.legend()
    plt.ylim((0, 1))
    plt.xlim((0, 1))
    plt.xlabel('False Positive Rate')
    plt.ylabel('True Positive Rate')
    pl.savefig("../result/d1_roc_vl_"+str(i)+"_b2.pdf")
    pl.figure()
    ...
    pl.plot(fpr_framelevel_CCSH_advanced_temp, tpr_framelevel_CCSH_advanced_temp, label='Local-CCSH_advanced',
            color='darkorange')
    ...
    pl.plot(fpr_videolevel_CCSH_advanced_temp, tpr_videolevel_CCSH_advanced_temp, label='Local-CCSH_advanced',
            color='darkorange')
    ...
    pl.savefig("../result/d1_roc_vl_"+str(i)+"_b2_focus.pdf")
...
pl.plot(sample_nums[:6],[F1_framelevel[0]]+F1_framelevel_CCSH_advanced[1:6], label='Local-CCSH_advanced',color='darkorange',marker='o')
#pl.hlines((precision_ahash_framelevel+recall_ahash_framelevel+F1_ahash_framelevel+iou_ahash_framelevel)/4,0,10,color='blue',linestyles='dashed',label="ahash")
...
plt.xticks(fontsize=12)
plt.yticks(fontsize=12)
pl.savefig("../result/d1_fl_b2_marker.pdf")
...
pl.plot(sample_nums[:6],[F1_videolevel[0]]+F1_videolevel_CCSH_advanced[1:6], label='Local-CCSH_advanced',color='darkorange',marker='o')
#pl.hlines((precision_ahash_videolevel+recall_ahash_videolevel+F1_ahash_videolevel+iou_ahash_videolevel)/4,0,10,color='blue',linestyles='dashed',label="ahash")
...
pl.savefig("../result/d1_vl_b2_marker.pdf")
...
pl.plot(sample_nums[:6],[F1_framelevel[0]]+F1_framelevel_b2[1:6],color='seagreen', label='Global-CCSH')
pl.plot(sample_nums[:6],F1_framelevel[:6], label='Local-CCSH',color='red')
pl.plot(sample_nums[:6],[F1_framelevel[0]]+F1_framelevel_CCSH_advanced[1:6], label='Local-CCSH_advanced',color='darkorange')
#pl.hlines((precision_ahash_framelevel+recall_ahash_framelevel+F1_ahash_framelevel+iou_ahash_framelevel)/4,0,10,color='blue',linestyles='dashed',label="ahash")
...
plt.xticks(fontsize=12)
plt.yticks(fontsize=12)
pl.savefig("../result/d1_fl_b2.pdf")
...
pl.plot(sample_nums[:6],[F1_videolevel[0]]+F1_videolevel_CCSH_advanced[1:6], label='Local-CCSH_advanced',color='darkorange')
#pl.hlines((precision_ahash_videolevel+recall_ahash_videolevel+F1_ahash_videolevel+iou_ahash_videolevel)/4,0,10,color='blue',linestyles='dashed',label="ahash")
...
pl.savefig("../result/d1_vl_b2.pdf")
