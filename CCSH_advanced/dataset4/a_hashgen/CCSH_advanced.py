...
for insertion_num in insertion_nums:
    ...
    if insertion_num<10:
        np.save('../data_advanced/hds_ahash_sample_advanced_0' + str(insertion_num) + '_deletion.npy', hds_forgery_arr)
        np.save('../data_advanced/hds_ahash_sample_advanced_0' + str(insertion_num) + '_deletion_compression.npy',
                hds_compression_arr)
    else:
        np.save('../data_advanced/hds_ahash_sample_advanced_' + str(insertion_num) + '_deletion.npy', hds_forgery_arr)
        np.save('../data_advanced/hds_ahash_sample_advanced_' + str(insertion_num) + '_deletion_compression.npy',
                hds_compression_arr)
