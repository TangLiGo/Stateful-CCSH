...
plt.xlabel('cN')
plt.ylabel('F1')
pl.savefig("../result/d4_fl_single1_CCSH_advanced.pdf")
...
plt.xlabel('cN')
plt.ylabel('F1')
pl.savefig("../result/d4_vl_single1_CCSH_advanced.pdf")
...
plt.xlabel('cN')
plt.ylabel('F1')
pl.savefig("../result/d4_fl_single2_CCSH_advanced.pdf")
...
plt.xlabel('cN')
plt.ylabel('F1')
pl.savefig("../result/d4_vl_single2_CCSH_advanced.pdf")
