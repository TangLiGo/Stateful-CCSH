...
data_path_CCSH_advanced="../data_advanced5/"
...
ahash_framelevel = np.load('../data_advanced5/roc_framelevel_data_ahash.npy', allow_pickle=True)
ahash_videolevel = np.load('../data_advanced5/roc_videolevel_data_ahash.npy', allow_pickle=True)
