...
for i in range(len(insert_nums)):
    ...
    pl.plot(fpr_framelevel_insertion_temp, tpr_framelevel_insertion_temp, label='CCSH')
    plt.legend()
    plt.ylim((0, 1))
    plt.xlim((0, 1))
    ...
    pl.plot(fpr_videolevel_insertion_temp, tpr_videolevel_insertion_temp, label='CCSH')
    plt.legend()
    plt.ylim((0, 1))
    plt.xlim((0, 1))
    plt.xlabel('False Positive Rate')
