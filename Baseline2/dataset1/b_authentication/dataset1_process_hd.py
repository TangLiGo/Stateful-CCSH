...
sample_nums = range(len(hds_ahash_samples))
...
for i in range(len(hds_ahash_samples)):
    ...
    if i<10:
        np.save('../data/roc_videolevel_0' + str(i) + '.npy', np.array(
        ...
        np.save('../data/roc_framelevel_0' + str(i) + '.npy', np.array(
        ...
        np.save('../data/roc_videolevel_' + str(i) + '.npy', np.array(
            [fpr_videolevel_temp, tpr_videolevel_temp, precision_videolevel_temp, recall_videolevel_temp,
             F1_videolevel_temp, iou_videolevel_temp], dtype=object))
        np.save('../data/roc_framelevel_' + str(i) + '.npy', np.array(
            [fpr_framelevel_temp, tpr_framelevel_temp, precision_framelevel_temp, recall_framelevel_temp,
             F1_framelevel_temp, iou_framelevel_temp], dtype=object))
    ...
    if i<10:
        np.save('../data/roc_videolevel_0' + str(i) + '_insertion.npy',
                np.array(
                    ...
                    dtype=object))
        np.save('../data/roc_framelevel_0' + str(i) + '_insertion.npy',
                np.array(
        ...
        np.save('../data/roc_videolevel_' + str(i) + '_insertion.npy',
                np.array(
                    [fpr_videolevel_insertion_temp, tpr_videolevel_insertion_temp, precision_videolevel_insertion_temp,
                     recall_videolevel_insertion_temp, F1_videolevel_insertion_temp, iou_videolevel_insertion_temp],
                    dtype=object))
        np.save('../data/roc_framelevel_' + str(i) + '_insertion.npy',
                np.array(
                    [fpr_framelevel_insertion_temp, tpr_framelevel_insertion_temp, precision_framelevel_insertion_temp,
                     recall_framelevel_insertion_temp, F1_framelevel_insertion_temp, iou_framelevel_insertion_temp],
                    dtype=object))
...
pl.figure()
pl.plot(sample_nums[1:],benchmarks_framelevel[1:], label='CCSHG - Object Removal')
...
pl.hlines((benchmarks_framelevel[0]+benchmarks_framelevel_insertion[0])/2,1,10,color='red',linestyles='dashed',label="RSHG")
...
pl.savefig("../result/d1_fl_double2.pdf")
...
pl.figure()
pl.plot(sample_nums[1:],benchmarks_videolevel[1:], label='CCSHG - Object Removal')
...
pl.hlines((benchmarks_videolevel[0]+benchmarks_videolevel_insertion[0])/2,1,10,color='red',linestyles='dashed',label="RSHG")
...
plt.xlabel('cN')
plt.ylabel('Detection Performance')
pl.savefig("../result/d1_vl_double2.pdf")