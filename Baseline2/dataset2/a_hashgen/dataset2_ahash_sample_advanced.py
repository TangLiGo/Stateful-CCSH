...
insertion_nums=range(1,11)#[5078.234375, 5073.171875, 5081.953125, 5100.796875, 5290.890625]      [6465.3125, 6316.0625, 6244.546875, 6206.84375, 6156.859375, 6166.28125, 6222.5, 6313.390625, 6315.25, 6129.375]
repeatTime=10
time_costs=[]
...
for insertion_num in insertion_nums:
    ...
    if insertion_num < 10:
        np.save('../data/dataset2/hds_ahash_sample_advanced_sample_insert0' + str(
            insertion_num) + '_insertion.npy',
                hds_forgery_arr)
        np.save('../data/dataset2/hds_ahash_sample_advanced_sample_insert0' + str(
            insertion_num) + '_insertion_compression.npy',
                hds_compression_arr)
    else:
        np.save('../data/dataset2/hds_ahash_sample_advanced_sample_insert' + str(
            insertion_num) + '_insertion.npy',
                hds_forgery_arr)
        np.save('../data/dataset2/hds_ahash_sample_advanced_sample_insert' + str(
            insertion_num) + '_insertion_compression.npy',
