...
for file in os.listdir(data_path):
    ...
    if 'hds_ahash_sample_advanced_' in file :
...
for i in range(len(hds_ahash_samples)):
    ...
    if i<10:
        np.save('../data/dataset3/roc_videolevel_0' + str(i) + '.npy', np.array(
        ...
        np.save('../data/dataset3/roc_framelevel_0' + str(i) + '.npy', np.array(
        ...
        np.save('../data/dataset3/roc_videolevel_' + str(i) + '.npy', np.array(
            [fpr_videolevel_temp, tpr_videolevel_temp, precision_videolevel_temp, recall_videolevel_temp,
             F1_videolevel_temp, iou_videolevel_temp], dtype=object))
        np.save('../data/dataset3/roc_framelevel_' + str(i) + '.npy', np.array(
            [fpr_framelevel_temp, tpr_framelevel_temp, precision_framelevel_temp, recall_framelevel_temp,
             F1_framelevel_temp, iou_framelevel_temp], dtype=object))
    ...
    if i<10:
        np.save('../data/dataset3/roc_videolevel_0' + str(i) + '_insertion.npy',
                np.array(
                    [fpr_videolevel_insertion_temp, tpr_videolevel_insertion_temp, precision_videolevel_insertion_temp,
                     recall_videolevel_insertion_temp, F1_videolevel_insertion_temp, iou_videolevel_insertion_temp],
                    dtype=object))
        np.save('../data/dataset3/roc_framelevel_0' + str(i) + '_insertion.npy',
                np.array(
                    [fpr_framelevel_insertion_temp, tpr_framelevel_insertion_temp, precision_framelevel_insertion_temp,
                     recall_framelevel_insertion_temp, F1_framelevel_insertion_temp, iou_framelevel_insertion_temp],
                    dtype=object))
    else:
        np.save('../data/dataset3/roc_videolevel_' + str(i) + '_insertion.npy',
                np.array(
                    [fpr_videolevel_insertion_temp, tpr_videolevel_insertion_temp, precision_videolevel_insertion_temp,
                     recall_videolevel_insertion_temp, F1_videolevel_insertion_temp, iou_videolevel_insertion_temp],
                    dtype=object))
        np.save('../data/dataset3/roc_framelevel_' + str(i) + '_insertion.npy',
                np.array(
                    [fpr_framelevel_insertion_temp, tpr_framelevel_insertion_temp, precision_framelevel_insertion_temp,
                     recall_framelevel_insertion_temp, F1_framelevel_insertion_temp, iou_framelevel_insertion_temp],
                    dtype=object))
...
for i in range(len(fpr_framelevel_insertion)):
...
pl.figure()
pl.plot(sample_nums,benchmarks_framelevel, label='deletion detection')
pl.plot(sample_nums,benchmarks_framelevel_insertion, label='insertion detection')
...
#pl.hlines((precision_ahash_sample+recall_ahash_sample+F1_ahash_sample+iou_ahash_sample)/4,0,5,color='red',linestyles='dashed',label='ahash_sample')
#pl.hlines((precision_ahash_sample_advanced+recall_ahash_sample_advanced+F1_ahash_sample_advanced+iou_ahash_sample_advanced)/4,5,30,color='black',linestyles='dashed',label='ahash_sample_advanced_original')
plt.legend()
pl.savefig("../data/dataset3_result//framelevel_benchmarks_ahash.png")
np.save('../data/dataset3/benchmarks_framelevel.npy',
        np.array([benchmarks_framelevel,benchmarks_framelevel_insertion],
                 dtype=object))
...
for i in range(len(fpr_videolevel_insertion)):
...
pl.figure()
pl.plot(sample_nums,benchmarks_videolevel, label='deletion detection')
pl.plot(sample_nums,benchmarks_videolevel_insertion, label='insertion detection')
...
#pl.hlines((precision_ahash_sample_advanced+recall_ahash_sample_advanced+F1_ahash_sample_advanced+iou_ahash_sample_advanced)/4,5,30,color='black',linestyles='dashed',label='ahash_sample_advanced_original')
plt.legend()
pl.savefig("../data/dataset3_result//videolevel_benchmarks_ahash.png")
np.save('../data/dataset3/benchmarks_videolevel.npy',
        np.array([benchmarks_videolevel,benchmarks_videolevel_insertion],
                 dtype=object))