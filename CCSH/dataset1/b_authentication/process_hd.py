    ...
    if 'hds_ahash_sample_advanced' in file :
        if 'insertion' in file:
            if "compression" in file:
                ahash_samples_insertion_compression_path.append(video_path)
            else:
                ahash_samples_insertion_path.append(video_path)
        else:
            if "compression" in file:
...
hds_ahash = np.load('../data_revised/hds_ahash.npy', allow_pickle=True)
hds_ahash_compression = np.load('../data_revised/hds_ahash_compression.npy', allow_pickle=True)
...
#hds_ahash_sample = np.load('../data_revised/hds_ahash_sample.npy', allow_pickle=True)
#hds_ahash_sample_compression = np.load('../data_revised/hds_ahash_sample_compression.npy', allow_pickle=True)
...
np.save('../data_revised/roc_videolevel_data_ahash.npy', np.array([fpr_ahash_videolevel, tpr_ahash_videolevel,precision_ahash_videolevel,recall_ahash_videolevel,F1_ahash_videolevel,iou_ahash_videolevel],dtype=object))
np.save('../data_revised/roc_framelevel_data_ahash.npy', np.array([fpr_ahash_framelevel, tpr_ahash_framelevel,precision_ahash_framelevel,recall_ahash_framelevel,F1_ahash_framelevel,iou_ahash_framelevel],dtype=object))

# np.save('../data_revised/roc_videolevel_data_ahash_sample.npy', np.array([fpr_ahash_sample_videolevel, tpr_ahash_sample_videolevel],dtype=object))
#np.save('../data_revised/roc_framelevel_data_ahash_sample.npy', np.array([fpr_ahash_sample_framelevel, tpr_ahash_sample_framelevel],dtype=object))
...
for i in range(len(hds_ahash_samples)):
    ...
    if i<10:
        np.save('../data_revised/roc_videolevel_0' + str(i) + '_deletion.npy', np.array(
        ...
        np.save('../data_revised/roc_framelevel_0' + str(i) + '_deletion.npy', np.array(
        ...
        np.save('../data_revised/roc_videolevel_' + str(i) + '_deletion.npy', np.array(
            [fpr_videolevel_temp, tpr_videolevel_temp, precision_videolevel_temp, recall_videolevel_temp,
             F1_videolevel_temp, iou_videolevel_temp], dtype=object))
        np.save('../data_revised/roc_framelevel_' + str(i) + '_deletion.npy', np.array(
            [fpr_framelevel_temp, tpr_framelevel_temp, precision_framelevel_temp, recall_framelevel_temp,
             F1_framelevel_temp, iou_framelevel_temp], dtype=object))


    print("processing",sample_names_insertion[i])
    framelevel_data_insertion,videolevel_data_insertion= data_processing(hds_ahash_samples_insertion[i],hds_ahash_samples_insertion_compression[i], 16, 16,
                                                                                         sample_names_insertion[i])
    fpr_framelevel_insertion_temp, tpr_framelevel_insertion_temp, precision_framelevel_insertion_temp, recall_framelevel_insertion_temp, F1_framelevel_insertion_temp, iou_framelevel_insertion_temp =framelevel_data_insertion

    fpr_videolevel_insertion_temp, tpr_videolevel_insertion_temp, precision_videolevel_insertion_temp, recall_videolevel_insertion_temp, F1_videolevel_insertion_temp, iou_videolevel_insertion_temp =videolevel_data_insertion
    if i<10:
        np.save('../data_revised/roc_videolevel_0' + str(i) + '_insertion.npy',
                np.array([fpr_videolevel_insertion_temp, tpr_videolevel_insertion_temp, precision_videolevel_insertion_temp,
                          recall_videolevel_insertion_temp, F1_videolevel_insertion_temp, iou_videolevel_insertion_temp],
                         dtype=object))
        np.save('../data_revised/roc_framelevel_0' + str(i) + '_insertion.npy',
                np.array([fpr_framelevel_insertion_temp, tpr_framelevel_insertion_temp, precision_framelevel_insertion_temp,
                          recall_framelevel_insertion_temp, F1_framelevel_insertion_temp, iou_framelevel_insertion_temp],
                         dtype=object))
    else:
        np.save('../data_revised/roc_videolevel_' + str(i) + '_insertion.npy',
                np.array([fpr_videolevel_insertion_temp, tpr_videolevel_insertion_temp, precision_videolevel_insertion_temp,
                          recall_videolevel_insertion_temp, F1_videolevel_insertion_temp, iou_videolevel_insertion_temp],
                         dtype=object))
        np.save('../data_revised/roc_framelevel_' + str(i) + '_insertion.npy',
                np.array([fpr_framelevel_insertion_temp, tpr_framelevel_insertion_temp, precision_framelevel_insertion_temp,
                          recall_framelevel_insertion_temp, F1_framelevel_insertion_temp, iou_framelevel_insertion_temp],
                         dtype=object))
    ...
    pl.plot(list(map(lambda x, y: (x + y)/2, fpr_framelevel[0], fpr_framelevel_insertion[0])), list(map(lambda x, y: (x + y)/2, tpr_framelevel[0], tpr_framelevel_insertion[0])), label='baseline')
  ...
  #  pl.plot(fpr_framelevel_insertion_temp, tpr_framelevel_insertion_temp, label='CCSHG-insertion')
    ...
    pl.savefig("../result_revised/d1_roc_fl_"+str(i)+".pdf")

    pl.figure()
    pl.plot(fpr_ahash_videolevel,tpr_ahash_videolevel,label='ahash')
    pl.plot(list(map(lambda x, y: (x + y)/2, fpr_videolevel[0], fpr_videolevel_insertion[0])), list(map(lambda x, y: (x + y)/2, tpr_videolevel[0], tpr_videolevel_insertion[0])), label='baseline')
  ...
  #  pl.plot(fpr_videolevel_insertion_temp, tpr_videolevel_insertion_temp, label='CCSHG-insertion')
    ...
    plt.xlabel('False Positive Rate')
    plt.ylabel('True Positive Rate')
    pl.savefig("../result_revised/d1_roc_vl_"+str(i)+".pdf")
