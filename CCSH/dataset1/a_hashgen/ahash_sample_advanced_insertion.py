...
for insertion_num in insertion_nums:
    ...
    if insertion_num<10:
        np.save('../data_insertion/hds_ahash_sample_advanced_0' + str(insertion_num) + '_insertion.npy', hds_forgery_arr)
        np.save('../data_insertion/hds_ahash_sample_advanced_0' + str(insertion_num) + '_insertion_compression.npy',
                hds_compression_arr)
    else:
        np.save('../data_insertion/hds_ahash_sample_advanced_' + str(insertion_num) + '_insertion.npy', hds_forgery_arr)
        np.save('../data_insertion/hds_ahash_sample_advanced_' + str(insertion_num) + '_insertion_compression.npy',
                hds_compression_arr)
