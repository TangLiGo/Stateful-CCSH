...
#hds_ahash_sample = np.load('../../data/dataset2/hds_ahash_sample.npy', allow_pickle=True)
...
for i in range(len(hds_ahash_samples_insertion)):
    ...
    if i>9:
        np.save('../data/framelevel_' + str(i) + '_insertion.npy',
                np.array([fpr_framelevel_insertion_temp, tpr_framelevel_insertion_temp, precision_framelevel_insertion_temp,
                         ...
                         dtype=object))
        np.save('../data/videolevel_' + str(i) + '_insertion.npy',
        ...
        np.save('../data/framelevel_0' + str(i) + '_insertion.npy',
                np.array([fpr_framelevel_insertion_temp, tpr_framelevel_insertion_temp, precision_framelevel_insertion_temp,
                          recall_framelevel_insertion_temp, F1_framelevel_insertion_temp, iou_framelevel_insertion_temp],
                         dtype=object))
        np.save('../data/videolevel_0' + str(i) + '_insertion.npy',
                np.array([fpr_videolevel_insertion_temp, tpr_videolevel_insertion_temp, precision_videolevel_insertion_temp,
                          recall_videolevel_insertion_temp, F1_videolevel_insertion_temp, iou_videolevel_insertion_temp],
                         dtype=object))
