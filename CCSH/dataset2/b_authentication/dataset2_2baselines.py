...
def drawBenchmarks(len_quota,benchmark_framelevel,benchmark_videolevel,ben_name):
    ...
    # pl.plot(sample_nums[1:],benchmarks_framelevel_b2[1:], label='CCSH - Object Insertion')
    ...
    pl.savefig("../result/d2fl_"+ben_name+"_single.pdf")


    pl.figure()
    pl.plot(x_data, benchmark_videolevel[1:len_quota], label='CCSH')
    # pl.plot(sample_nums[1:],benchmarks_videolevel_b2[1:], label='CCSH - Object Insertion')
   ...
   # pl.vlines(5, 0.85, 1, color='black', linestyles='dashed')
    ...
    plt.xlabel('cN')
    plt.ylabel('Detection Performance')
    pl.savefig("../result/d2vl_"+ben_name+"_single.pdf")
...
b2_framelevel_path=[]
b2_videolevel_path=[]
data_path_b2="../../../Baseline2/dataset2/data/"
...
for i in range(len_quota):
    ...
    pl.figure()
    pl.plot(fpr_ahash_framelevel,tpr_ahash_framelevel,label='ahash',color='black')
    pl.plot(fpr_framelevel[0],  tpr_framelevel[0],  label='baseline 1',color='steelblue')
    pl.plot(fpr_framelevel_b2_temp, tpr_framelevel_b2_temp, label='baseline 2', color='seagreen')
    pl.plot(fpr_framelevel_temp, tpr_framelevel_temp, label='CCSH',color='red')
    ...
    pl.savefig("../result/d2_roc_fl_"+str(i)+"_b2.pdf")

    pl.figure()
    pl.plot(fpr_ahash_videolevel,tpr_ahash_videolevel,label='ahash',color='black')
    pl.plot(fpr_videolevel[0],  tpr_videolevel[0],  label='baseline 1',color='steelblue')
    pl.plot(fpr_videolevel_b2_temp, tpr_videolevel_b2_temp, label='baseline 2', color='seagreen')
    pl.plot(fpr_videolevel_temp, tpr_videolevel_temp, label='CCSH',color='red')
    ...
    pl.savefig("../result/d2_roc_vl_"+str(i)+"_b2.pdf")
    pl.figure()
    fig,ax=pl.subplots(1,1)
    ax.plot(fpr_ahash_videolevel,tpr_ahash_videolevel,label='ahash',color='black')
    ax.plot(fpr_videolevel[0],  tpr_videolevel[0],  label='baseline 1',color='steelblue')
    ax.plot(fpr_videolevel_b2_temp, tpr_videolevel_b2_temp, label='baseline 2', color='seagreen')
    ax.plot(fpr_videolevel_temp, tpr_videolevel_temp, label='CCSH',color='red')
    ...
    axins.plot(fpr_videolevel[0],  tpr_videolevel[0],  label='baseline 1',color='steelblue')
    axins.plot(fpr_videolevel_b2_temp, tpr_videolevel_b2_temp, label='baseline 2', color='seagreen')
    ...
    pl.savefig("../result/d2_roc_vl_"+str(i)+"_b2_focus.pdf")




pl.figure()
pl.hlines(F1_framelevel[0],1,5,color='red',linestyles='dashed',label="baseline 1")
pl.plot(sample_nums[1:6],F1_framelevel_b2[1:6], label='baseline 2')
...
plt.xlabel('cN')
plt.ylabel('F1')
pl.savefig("../result/d2fl_single1_b2.pdf")

pl.figure()
pl.hlines(F1_videolevel[0],1,5,color='red',linestyles='dashed',label="baseline 1")
pl.plot(sample_nums[1:6],F1_videolevel_b2[1:6], label='baseline 2 ')
...
plt.xlabel('cN')
plt.ylabel('F1')
pl.savefig("../result/d2vl_single1_b2.pdf")

pl.figure()
pl.plot(sample_nums[:6],[F1_framelevel[0] for i in range(len_quota)],color='steelblue',label="baseline 1")
pl.plot(sample_nums[:6],[F1_framelevel[0]]+F1_framelevel_b2[1:6],color='seagreen', label='baseline 2')
pl.plot(sample_nums[:6],F1_framelevel[:6], label='CCSH',color='red')
...
plt.xticks(fontsize=12)
plt.yticks(fontsize=12)
pl.savefig("../result/d2_fl_b2.pdf")

pl.figure()
pl.plot(sample_nums[:6],[F1_videolevel[0] for i in range(len_quota)],color='steelblue',label="baseline 1")
pl.plot(sample_nums[:6],[F1_videolevel[0]]+F1_videolevel_b2[1:6], label='baseline 2',color='seagreen')
pl.plot(sample_nums[:6],F1_videolevel[:6], label='CCSH',color='red')
#pl.hlines((precision_ahash_videolevel+recall_ahash_videolevel+F1_ahash_videolevel+iou_ahash_videolevel)/4,0,10,color='blue',linestyles='dashed',label="ahash")
...
pl.savefig("../result/d2_vl_b2.pdf")
