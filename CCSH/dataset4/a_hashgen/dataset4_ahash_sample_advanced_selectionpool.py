...
insertion_nums=range(6,10)#[5078.234375, 5073.171875, 5081.953125, 5100.796875, 5290.890625]
repeatTime=2
time_costs=[]
for insertion_num in insertion_nums:
    ...
    if insertion_num<10:
        np.save('hds_ahash_sample_advanced_0' + str(insertion_num) + '_deletion.npy', hds_forgery_arr)
        np.save('hds_ahash_sample_advanced_0' + str(insertion_num) + '_deletion_compression.npy',
                hds_compression_arr)
    else:
        np.save('hds_ahash_sample_advanced_' + str(insertion_num) + '_deletion.npy', hds_forgery_arr)
        np.save('hds_ahash_sample_advanced_' + str(insertion_num) + '_deletion_compression.npy',
                hds_compression_arr)
