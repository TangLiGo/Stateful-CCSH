...
def data_processing(nums_forgery,nums_compression,hash_len,high_threshold,hash_name):
    ...
    print("frame level")
    img_path="../result_win20/framelevel_"+hash_name+".pdf"
    ...
    print("video level")
    img_path = "../result_win20/videolevel_" + hash_name + ".pdf"
...
#hds_ahash_sample = np.load('../../data_win20/hds_ahash_sample.npy', allow_pickle=True)
#hds_ahash_sample_compression = np.load('../../data_win20/hds_ahash_sample_compression.npy', allow_pickle=True)
...
np.save('../data_win20/roc_videolevel_data_ahash.npy', np.array([fpr_ahash_videolevel, tpr_ahash_videolevel,precision_ahash_videolevel,recall_ahash_videolevel,F1_ahash_videolevel,iou_ahash_videolevel],dtype=object))
np.save('../data_win20/roc_framelevel_data_ahash.npy', np.array([fpr_ahash_framelevel, tpr_ahash_framelevel,precision_ahash_framelevel,recall_ahash_framelevel,F1_ahash_framelevel,iou_ahash_framelevel],dtype=object))

# np.save('../../data_win20/roc_videolevel_data_ahash_sample.npy', np.array([fpr_ahash_sample_videolevel, tpr_ahash_sample_videolevel],dtype=object))
#np.save('../../data_win20/roc_framelevel_data_ahash_sample.npy', np.array([fpr_ahash_sample_framelevel, tpr_ahash_sample_framelevel],dtype=object))
...
for i in range(len(hds_ahash_samples)):
    ...
    if i<10:
        np.save('../data_win20/roc_videolevel_0' + str(i) + '_deletion.npy', np.array(
        ...
        np.save('../data_win20/roc_framelevel_0' + str(i) + '_deletion.npy', np.array(
        ...
        np.save('../data_win20/roc_videolevel_' + str(i) + '_deletion.npy', np.array(
            [fpr_videolevel_temp, tpr_videolevel_temp, precision_videolevel_temp, recall_videolevel_temp,
             F1_videolevel_temp, iou_videolevel_temp], dtype=object))
        np.save('../data_win20/roc_framelevel_' + str(i) + '_deletion.npy', np.array(
            [fpr_framelevel_temp, tpr_framelevel_temp, precision_framelevel_temp, recall_framelevel_temp,
             F1_framelevel_temp, iou_framelevel_temp], dtype=object))
  ...
  #  pl.plot(fpr_framelevel_insertion_temp, tpr_framelevel_insertion_temp, label='CCSHG-insertion')
    ...
    pl.savefig("../result_win20/d1_roc_fl_"+str(i)+".pdf")
  ...
  #  pl.plot(fpr_videolevel_insertion_temp, tpr_videolevel_insertion_temp, label='CCSHG-insertion')
    ...
    plt.xlabel('False Positive Rate')
    plt.ylabel('True Positive Rate')
    pl.savefig("../result_win20/d1_roc_vl_"+str(i)+".pdf")
