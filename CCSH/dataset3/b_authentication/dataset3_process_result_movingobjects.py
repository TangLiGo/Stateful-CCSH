...
ahash_framelevel = np.load('../data_movingobjects/roc_framelevel_data_ahash.npy', allow_pickle=True)
ahash_videolevel = np.load('../data_movingobjects/roc_videolevel_data_ahash.npy', allow_pickle=True)
