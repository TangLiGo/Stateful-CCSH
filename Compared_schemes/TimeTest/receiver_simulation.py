...
hashes_path=video_path.replace('.mp4','_compared_all_frame_perceptualhash.npy')
hashes_path=hashes_path.replace('Forged','Real')
hashes_PVH=np.load(video_path.replace('.mp4','_compared_all_frame_perceptualhash.npy'),allow_pickle=True)
