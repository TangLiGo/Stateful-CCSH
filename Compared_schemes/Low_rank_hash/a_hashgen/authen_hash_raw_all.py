...
def traverseVideo(dataset=4):
    ...
    for i in range(len(data_path)):
        ...
        for file in os.listdir(path):
            ...
            if ('Real' in file or 'original' in file) and "_compared_LRH_N=1.npy" in file:
                original_videos[i].append(video_path)
            elif ('Forged' in file or 'forged' in file)and "_compared_LRH_N=1.npy" in file:
...
#np.save('data/dataset1_LRH_n_1hash_distances.npy',[hds_forgery,hds_compression])
