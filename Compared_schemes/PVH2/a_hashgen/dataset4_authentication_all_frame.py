...
def data_processing(nums_forgery,nums_compression):
   # forged_info = [[100, 133], [111, 187], [99, 172], [95, 181], [64, 72], [1, 32], [103, 143], [120, 138], [77, 131],
    ...
    forged_info = [[100, 133], [110, 187], [99, 172], [94, 181], [63, 72], [0, 31], [102, 142], [119, 137], [76, 131], [58, 75], [82, 126], [65, 99], [5, 48], [50, 70], [106, 132], [0, 30]]
...
def traverseVideo():
    ...
    for i in range(len(data_path)):
        ...
        for file in os.listdir(path):
            ...
            if 'Real' in file and "_compared_perceptualhash_v2" in file:
...
np.save('data/dataset4_authen_sample_frame.npy',[hds_forgery,hds_compression])
