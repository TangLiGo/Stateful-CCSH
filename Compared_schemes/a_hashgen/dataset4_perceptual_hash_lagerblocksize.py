...
def gen_hash(video_path):
    ...
    print(height,width)
    H_3D,V_3D,T_3D=feature_extraction(frame_samples,[int(width/block_num),int(width/block_num)])
  #  print("3d", H_3D[0][1][1])
    ...
    for i in range(len(data_path)):
        ...
        for file in os.listdir(path):
            ...
            if '.mp4' in file:
                ...
                db_path = path + '/' + file_name + '_compared_block_num_10_perceptualhash.npy'
