...
def data_processing(nums_forgery,nums_compression,dataset):
  ...
  #  print(low_thresholds)
    ...
    print("forged_frame_num",forged_frame_num,forged_video_frame_num)
...
def traverseVideo(dataset=4):
    ...
    for i in range(len(data_path)):
        ...
        for file in os.listdir(path):
            ...
            if ('Real' in file or 'original' in file) and "_compared_TD.npy" in file:
                original_videos[i].append(video_path)
            elif ('Forged' in file or 'forged' in file)and "_compared_TD.npy" in file:
